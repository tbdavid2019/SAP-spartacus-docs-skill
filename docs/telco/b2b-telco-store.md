...
<p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/homepage.png" alt="Homepage"></p>
...
<p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/category-page.png" alt="Category Page"></p>
...
<p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/content-page.png" alt="Content Page"></p>

**Purchase Process**

In the purchase journey for a BPO, in this case, the customer needs to select from different configurable characteristics.

<p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/bpo-satellite-service.png" alt="BPO Satellite Service"></p>
...
1.  **Speed plans**: Select the required monthly speed plan
    ...
    <p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/speed-plan.png" alt="Speed Plan"></p>

1.  **Terminals**: Select only if required. It is not a mandatory option.

    <p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/terminals.png" alt="Terminals"></p>

1.  **Addons**: Select the required addon.

    <p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/addons.png" alt="Addons"></p>

1.  Click **Add to Cart** after selecting all the required items. The popup window displays the list of all selected items.

1.  Click **View Cart**.

    <p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/view-cart.png" alt="View Cart"></p>
...
1.  Select **Individual LATAM Country Add-ons**.
    ...
    <p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/individual-country-addons.png" alt="Individual Country Addons"></p>
...
1.  Click **Proceed To Checkout**.
    ...
    <p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/proceed-to-checkout-cartitems.png" alt="Proceed to checkout Cartitems"></p>
...
1.  Click **Continue**.
    ...
    <p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/b2b-checkout-page.png" alt="B2B Checkout Page"></p>
...
1.  Click **Place Order**.
    ...
    <p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/placeorder.png" alt="Place Order"></p>

1.  The **Order Confirmation** page displays the details of the order placed.

    <p align="center"><img src="https://sap.github.io/spartacus-docs/assets/images/telco/orderconfirmation.png" alt="Order Confirmation"></p>
