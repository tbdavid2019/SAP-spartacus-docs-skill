...
**You can now start TUA Spartacus!** After you have configured SAP Commerce Cloud to accept OCC REST API calls, you can set up and start your storefront. See [Building the TUA Spartacus Storefront Using 1.2 Libraries](building-the-tua-storefront-from-libraries-1-2.md) for more information.
