...
- [Selfcare - Viewing Subscriptions, Billing Account, and Billing Agreement](selfcare-subscriptions-billingaccount-agreements.md)
...
- [Updating to Version 4.0](updating-tua-spartacus-to-4.md)
- [Technical Changes in TUA Spartacus 4.0](technical-changes-tua-version-4.md)
- Uses Angular 12.

You can refer to the core [Release Information for All Versions of Spartacus Libraries](../home/release-information.md) for all versions of Spartacus Libraries documentation for updates on the Spartacus framework including the upgrade to Angular 12 and related dependencies.

**Note:** For information on core commerce Spartacus, see [Updating to Version 4.0](../home/updating-to-version-4/updating-to-version-4.md).
...
- [B2B Approval Workflow Processes](b2b-order-approval.md)
- [B2B Organizational Management](b2b-organization-management.md)
- [B2B Telco Spartacus Storefront](b2b-telco-store.md)
- [Purchase PO with Configurable Characteristics](purchase-po-with-configurable-characteristics.md)
...
- [Media Storefront](media-storefront.md)
...
- Uses Angular 10.
- [Updating to Version 3.0](updating-tua-spartacus-to-3.md).
- [Technical Changes in TUA Spartacus 3.0](technical-changes-tua-version-3.md).
...
- [Contract (subscription) renewal without assurance](renewal-of-standalone-spo.md).
- [Contract (subscription) termination without assurance](contract-termination.md).
- [Serviceability Check](journey-management-serviceability-check-of-spo.md). This feature documentation covers serviceability check of a selected single product offering (SPO) and also serviceability check of all product offerings at the specified address.

You can refer to the core [Release Information](telco-release-information.md) for all versions of Spartacus Libraries documentation for updates on the Spartacus framework including the upgrade to Angular 10 and related dependencies.

**Note:** For information on core commerce Spartacus, see [Updating to Version 3.0](../home/updating-to-version-3/updating-to-version-3.md).
...
- [Updating to Version 2.0](updating-tua-spartacus-to-2.md)
- [Technical Changes in TUA Spartacus 2.0](technical-changes-tua-version-2.md)
- [Changes to Styles in 2.0](../home/updating-to-version-2/css-changes-in-version-2.md)

Please refer to core [Release Information for All Versions of Spartacus Libraries](../home/release-information.md) documentation for updates on the Spartacus framework including the upgrade to Angular 9 and related dependencies.
...
- [Pricing - Price Alteration Discounts](price-alteration-discounts.md)
...
- [Journey Management - Appointment Scheduling](journey-management-appointment-scheduling.md)
...
- [Journey Management - Serviceability (Premise Details)](journey-management-serviceability.md)
...
- [Journey Management - MSISDN](journey-management-msisdn.md)
...
- [Customer Product Inventory (CPI)](customer-product-inventory.md)
...
- [Simple Product Offering](simple-product-offering.md)
...
- [Product Offering Search](product-offering-search.md)
...
- [Configurable Guided Selling](configurable-guided-selling.md)
...
- [ Pricing - Subscription Rate Plan](product-offering-prices.md)
...
- Please visit our Spartacus for TUA Compatibility Matrix to understand requirements. For more information, see [Feature Compatibility Matrix](tua-feature-release-versions.md).
...
For more information, see [Roadmap for TUA Spartacus](tua-spartacus-roadmap.md).
