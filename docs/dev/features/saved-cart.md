...
You can enable the saved cart feature by installing the `@spartacus/cart` feature library. For more information, see [Installing Additional Spartacus Libraries](https://sap.github.io/spartacus-docs/schematics/#installing-additional-spartacus-libraries).
...
If you are using the [spartacussampledata extension](../../install/spartacussampledata-extension.md), the saved cart components are already enabled. However, if you decide not to use the extension, you can enable them through ImpEx.
...
1. Add one or more items to your cart, then open the **Cart** page.
   ...
   <img src="https://sap.github.io/spartacus-docs/assets/images/saved-carts-1.png" alt="Shopping Cart" width="800" border="1px" />

1. Click **Save Cart For Later**.

   The **Save For Later** dialog box appears:

   <img src="https://sap.github.io/spartacus-docs/assets/images/saved-carts-2.png" alt="Save For Later dialog box" width="800" border="1px" />
...
<img src="https://sap.github.io/spartacus-docs/assets/images/saved-carts-3.png" alt="Accessing the Saved Carts History Page" width="800" border="1px" />
...
<img src="https://sap.github.io/spartacus-docs/assets/images/saved-carts-4.png" alt="Saved Carts History Page" width="800" border="1px" />
...
<img src="https://sap.github.io/spartacus-docs/assets/images/saved-carts-4-dialog-clone.png" alt="Save For Later dialog box with copy saved cart enabled" width="800" border="1px" />
...
<img src="https://sap.github.io/spartacus-docs/assets/images/saved-carts-5.png" alt="Saved Carts Details Page" width="800" border="1px" />
