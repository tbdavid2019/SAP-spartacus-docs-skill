...
![Adding documents through claim card](https://sap.github.io/spartacus-docs/assets/images/fsa/claims/claim-update-claims-page.png)

The same button can be found on the Claim Details page, in the Documents section.

![Adding documents from Claims Details page](https://sap.github.io/spartacus-docs/assets/images/fsa/claims/claim-update-claims-details-page.png)
...
![Adding documents to the claim](https://sap.github.io/spartacus-docs/assets/images/fsa/claims/claim-update-adding-documents.png)
...
For more information, see [Document Upload](../dynamicforms/core/form-controls-document-upload.md).
