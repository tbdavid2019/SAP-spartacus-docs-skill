...
![Accessing Seller Dashboard](https://sap.github.io/spartacus-docs/assets/images/fsa/OBO/seller-dashboard-access-link.png)
...
![Seller Dashboard Preview](https://sap.github.io/spartacus-docs/assets/images/fsa/OBO/seller-dashboard-overview.png)
...
![Adding New Customer](https://sap.github.io/spartacus-docs/assets/images/fsa/OBO/seller-dashboard-add-customer.png)

After that, the seller fills in the form with customer data, such as customer name, e-mail address and date of birth.

![Create Customer Form](https://sap.github.io/spartacus-docs/assets/images/fsa/OBO/seller-dashboard-create-customer-form.png)

After saving the changes, seller can see the newly created customer in their list of customers on the Dashboard.

![Customer List on the Seller Dashboard](https://sap.github.io/spartacus-docs/assets/images/fsa/OBO/seller-dashboard-customer-list.png)
...
![Customer List on Quote Review Step](https://sap.github.io/spartacus-docs/assets/images/fsa/OBO/seller-customer-selected.png)
...
![Toast Message Informing the Seller that the Quote is Created](https://sap.github.io/spartacus-docs/assets/images/fsa/OBO/seller-creates-quote-for-customer-notification.png)
...
![Seller Accessing Customer Dashboard](https://sap.github.io/spartacus-docs/assets/images/fsa/OBO/agent-dashboard-to-customer-dashboard.png)
...
![Seller Dashboard Content Slots](https://sap.github.io/spartacus-docs/assets/images/fsa/OBO/seller-dashboard-content-slots.png)
...
For more information, see [My Dashboard](fsa-my-dashboard.md).
