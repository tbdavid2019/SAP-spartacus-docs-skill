...
![product finder carousel](https://sap.github.io/spartacus-docs/assets/images/fsa/product-discovery/fsa-product-discovery.png)
...
![recommended product](https://sap.github.io/spartacus-docs/assets/images/fsa/product-discovery/fsa-product-discovery-recommended-product-backend.png)

![recommended product](https://sap.github.io/spartacus-docs/assets/images/fsa/product-discovery/fsa-product-discovery-recommended-product-storefront.png)
