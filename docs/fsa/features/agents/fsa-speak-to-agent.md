...
![CmsSyncPilotComponent in the Quotation Process](https://sap.github.io/spartacus-docs/assets/images/fsa/agents/CmsSyncPilotComponent-checkout.png)

The elements of the component that can be configured are the title and the icon class.

![CmsSyncPilotComponent](https://sap.github.io/spartacus-docs/assets/images/fsa/agents/CmsSyncPilotComponent2.png)
...
![Speak to an Agent Component](https://sap.github.io/spartacus-docs/assets/images/fsa/agents/speak_to_agent.png)
...
![GenericSyncPilotComponent on the Agent Card in Map View](https://sap.github.io/spartacus-docs/assets/images/fsa/agents/CmsSyncPilotComponent-agent-map-full.png)

*GenericSyncPilotComponent on the Agent Card in List View*

![GenericSyncPilotComponent on the Agent Card in List View](https://sap.github.io/spartacus-docs/assets/images/fsa/agents/CmsSyncPilotComponent-agent-list-full.png)
