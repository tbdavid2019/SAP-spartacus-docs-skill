...
Coupons in FSA Spartacus make use of the [Coupons](../../dev/features/coupons.md) and [Customer Coupons](../../dev/features/customer-coupons.md) features implemented in the core Commerce Spartacus. Coupons must be activated and their corresponding promotion rules must be published in the Backoffice before they can be applied in the storefront. See [Coupon Module](https://help.sap.com/viewer/9d346683b0084da2938be8a285c0c27a/latest/en-US/d35c247bac2d4c91a6ca4501b63cb2b4.html) for more details.
...
![My Coupons](https://sap.github.io/spartacus-docs/assets/images/fsa/my_coupons.png)
...
![Applying coupon code](https://sap.github.io/spartacus-docs/assets/images/fsa/applying_coupon_code.png)
...
![Coupon code applied to the cart](https://sap.github.io/spartacus-docs/assets/images/fsa/coupon_code_applied.png)
...
![Reduced price on Order Details page](https://sap.github.io/spartacus-docs/assets/images/fsa/coupons_order_history.png)
