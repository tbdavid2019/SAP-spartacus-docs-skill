...
![Accessing Chatbot from the Homepage](https://sap.github.io/spartacus-docs/assets/images/fsa/chatbot/chatbot_homepage.png)

When the customer opens the dialog box, the bot greets them with a welcome message.

![Chatbot Welcome Message](https://sap.github.io/spartacus-docs/assets/images/fsa/chatbot/chatbot_welcome_message.png)
...
![Chatbot Header](https://sap.github.io/spartacus-docs/assets/images/fsa/chatbot/chatbot_header.png)
...
![Beginning of the Customer Ticket Creation Flow](https://sap.github.io/spartacus-docs/assets/images/fsa/chatbot/chatbot_create_customer_ticket_flow.png)
...
![Customer Writing Flow in Chatbot](https://sap.github.io/spartacus-docs/assets/images/fsa/chatbot/chatbot_customer_ticket_flow_claim_information.png)

The customer can also edit the message or the subject of the ticket.

![Editing Ticket Content in Chatbot](https://sap.github.io/spartacus-docs/assets/images/fsa/chatbot/chatbot_customer_ticket_flow_edit.png)
...
![End of Conversation in Chatbot](https://sap.github.io/spartacus-docs/assets/images/fsa/chatbot/chatbot_customer_ticket_flow_end.png)
...
![Chatbot Product Info](https://sap.github.io/spartacus-docs/assets/images/fsa/chatbot/chatbot_product_info.png)
