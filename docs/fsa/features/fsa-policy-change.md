...
![Policy Details Page - Change Mileage](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/policy-details-change-mileage.png)
...
![Change Mileage - Change Car Details](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/change-mileage-step1.png)

![Change Mileage - Change Preview](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/change-mileage-step2.png)
...
![Change Confirmation Page](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/cr_confirmation.png)
...
![Policy Details Page - Edit Coverage Details](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/policy-details-add-or-remove_coverage.png)
...
![Change Coverage Step](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/change_coverage.png)
...
![Add Coverage Preview Step](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/add-coverage-step2.png)

Example of a Change Preview page when the user removes existing coverage:

![Remove Coverage Preview Step](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/remove-coverage-step2.png)
...
![Form for Adding Additional Driver](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/additional_driver_form.png)
...
![Add Driver Change Preview Step](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/add-driver-step2.png)
...
![Policy Details Page with Additional Driver Added](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-change/policy-details-driver-added.png)
