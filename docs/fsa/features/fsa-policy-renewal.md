...
The renewal process relies heavily on the FSA Spartacus' Quote Comparison feature. For more detailed information, see [Quote Comparison](fsa-quote-comparison.md).

## User Journey

When a policy is up for renewal, the policyholder receives a notification about it in the Inbox.

![Renewal Notifications in the Inbox](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-renewal/inbox-notification-unread.png)

Besides the appropriate text, the Inbox message contains the link that leads the customer directly to renewal options.

![Renewal Notification Text](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-renewal/inbox-notification-text.png)
...
![Renewal Quotes Comparison View - Auto Insurance](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-renewal/comparison-table-view-auto.png)
...
![Renewal Quotes Comparison View - Life Insurance](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-renewal/comparison-table-view-life-selectQuoteButton.png)
...
![Filtering Renewal Quotes on Quotes and Applications page](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-renewal/renewal-quotes-filter.png)
...
![Comparing Renewal Quotes from Quotes and Applications page](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-renewal/quotes-and-applications-renewal-with-toast-message.png)
...
![Highlighted Quote Based on Existing Policy](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-renewal/comparison-table-view-auto-highlighted-offer.png)

After examining the renewal offers, the customer opts for one of the offers by clicking the **SELECT QUOTE** button.

![Select Quote Button](https://sap.github.io/spartacus-docs/assets/images/fsa/policy-renewal/comparison-view-auto-selectQuoteButton.png)
