...
The following instructions describe how to build an FSA storefront application using published FSA Spartacus 2.x libraries. If you are building Spartacus from source, see [Contributor Setup](../../contributing/contributor-setup.md).
